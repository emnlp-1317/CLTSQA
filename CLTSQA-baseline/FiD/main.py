...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.model_path:
        ...
        t5 = T5ForConditionalGeneration.from_pretrained(model_id)
        model = FiDT5(config)
    ...
    if cfg.mode == 'train':
        ...
        for epoch in iterator:
            output_dir = "checkpoints/fid/cl_one/checkpoint-epoch-{}".format(epoch)
    ...
    if cfg.mode == 'eval':
        ...
        with open('output/examples_scores/fid-1-scores.json', 'w') as f1:
            json.dump(scores,f1) 
